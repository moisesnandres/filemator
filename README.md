...
Open `Filemator.xcodeproj` in Xcode and run (Cmd+R). To run the unit/integration tests without launching the app (the `FilematorUITests` target launches the real built app, which will start watching your actual Downloads folder):
